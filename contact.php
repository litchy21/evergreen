                ...
                <form class="form-horizontal" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="email" name="email" type="text" placeholder="Adresse email" class="form-control" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" id="message" name="message" placeholder="Entrez ici votre message. Merci !" rows="7" required=""></textarea>
                            </div>
                        </div>
